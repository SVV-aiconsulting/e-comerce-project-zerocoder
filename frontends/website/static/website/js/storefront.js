(() => {
  ...
  function renderAssistantGreeting() {
    ...
    appendAssistantMessage(
      "assistant",
      "Здравствуйте! Напишите, что хотите заказать. Помогу выбрать товары из каталога, рассчитать доставку и оформить оплату. Номер телефона понадобится только для оформления доставки."
    );
  }
