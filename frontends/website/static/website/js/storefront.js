(() => {
  ...
  function renderAssistantGreeting() {
    ...
    appendAssistantMessage(
      "assistant",
      "Здравствуйте! Напишите, что хотите заказать. Помогу выбрать товары из каталога, рассчитать доставку и оформить оплату. Перед оформлением попрошу имя и номер телефона."
    );
  }
