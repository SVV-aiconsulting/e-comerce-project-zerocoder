...
env = environ.Env(
    ...
    AI_ASSISTANT_MAX_TOOL_CALLS=(int, 8),
    AI_ASSISTANT_HISTORY_MESSAGES=(int, 20),
    AI_ASSISTANT_STALE_CART_SECONDS=(int, 3600),
...
YOOKASSA_TAX_SYSTEM_CODE = env.int("YOOKASSA_TAX_SYSTEM_CODE", default=0)
...
# LLM ведёт диалог и выбирает только объявленные типизированные инструменты.
# ORM/SQL, цены, доставка, CRM, подтверждение и платёж остаются в backend.
...
AI_ASSISTANT_MAX_TOOL_CALLS = env("AI_ASSISTANT_MAX_TOOL_CALLS")
AI_ASSISTANT_HISTORY_MESSAGES = env("AI_ASSISTANT_HISTORY_MESSAGES")
AI_ASSISTANT_STALE_CART_SECONDS = env("AI_ASSISTANT_STALE_CART_SECONDS")
